      ...
      <DialogContent className="sm:max-w-md">
        <form onSubmit={submit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Der Nutzer erhält die offizielle Einladungs-E-Mail. Über den Link legt er beim ersten
              Öffnen sein eigenes Passwort fest.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            <Button type="submit" disabled={busy}>
              {busy ? <Loader2 className="mr-1.5 h-4 w-4 animate-spin" /> : null} Einladung senden
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
